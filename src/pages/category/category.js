...
import DesignerWear from '../../components/category/DesignerWear';

const Category = () => {
    const [age, setAge] = useState('');
    const [key, setKey] = useState('designer_wear');
                ...
                <div className='container'>
                    <div className="cloth_inner">
                        ...
                        <Tabs
                            ...
                            >
                            <Tab eventKey="designer_wear" title="Designer Wear">
                              <DesignerWear />
                             </Tab>
                        ...
                        <Tab eventKey="sangeet" title="Sangeet">
                        <div className='row' style={{ marginTop: "10px" }}>
                        <div className="col-md-8">
                                <div className='cloth_deatils_wrap'>
                                    <Link to="/product" className='cloth_deatils_link'>
                        ...
                        <Tab eventKey="all_bridal" title="All Bridal">
                        <div className='row' style={{ marginTop: "10px" }}>
                        <div className="col-md-4">
                                <div className='cloth_deatils_wrap'>
                                    <Link to="/product" className='cloth_deatils_link'>
