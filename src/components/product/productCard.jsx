...
const ProductCard = ({ product, setSwipeableDisable }) => {
            ...
            <div className="product_page">
                <div className="product_slider_section">
                    <div className="row">
                        ...
                        <div className="col-md-6 product_info_right_section_wrap" onMouseEnter={() => setSwipeableDisable(true)} onTouchStart={() => setSwipeableDisable(true)}>
                            <div>
