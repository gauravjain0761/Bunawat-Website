...
const TrackOrder = ({show, handleClose}) => {
                        ...
                        otpverify ? null : (
                            <div className="login_wrap">
                                ...
                                <div className="login_input_inner">
                                        <input type="text" placeholder="Order Number" style={{padding: "10px 15px 10px 15px"}} />
                        ...
                        otpverify ? (
                            <div className="login_wrap">
                                <div className="login_title_wrap">
                                    ...
                                    <h4>Enter the OTP we sent to <a>+91 91283 61521</a></h4>
                                </div>
                                <div className="login_input_wrap">
                                    <div className="login_input_inner">
