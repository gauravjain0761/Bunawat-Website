    ...
    return (
        <Box>
            ...
            <AppBar component="nav"
                position='fixed' sx={{
                    boxShadow: 'none',
                    backgroundColor: scroll || headerColor ? "white" : "transparent",
                    opacity: scroll ? .9 : 1,
                    borderRadius: scroll ? "10px" : "0px",
                    top: scroll ? "8px" : "0px",
                    right: scroll ? "6px" : "0px",
                    width: scroll ? "99%" : "100%",
                    marginLeft: "auto",
                    marginRight: "auto"
                    // left: scroll ? "8px" : "0px",
                    // right: scroll ? "8px" : "0px"
                }}>
                        ...
                        <Stack direction="row" alignItems="center">
                                ...
                                <IconButton
                                    ...
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_6128_2675)">
                                            <path d="M12.52 23.9902C18.678 23.9902 23.67 18.9982 23.67 12.8402C23.67 6.68221 18.678 1.69019 12.52 1.69019C6.36202 1.69019 1.37 6.68221 1.37 12.8402C1.37 18.9982 6.36202 23.9902 12.52 23.9902Z" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                            <path d="M12.52 14.7001C14.6905 14.7001 16.45 12.9406 16.45 10.7701C16.45 8.59961 14.6905 6.84009 12.52 6.84009C10.3495 6.84009 8.59003 8.59961 8.59003 10.7701C8.59003 12.9406 10.3495 14.7001 12.52 14.7001Z" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                            <path d="M18.27 22.3802C18.43 21.8502 18.51 21.2802 18.51 20.7002C18.51 17.3902 15.83 14.7102 12.52 14.7102C9.21003 14.7102 6.53003 17.3902 6.53003 20.7002C6.53003 21.2802 6.62003 21.8502 6.77003 22.3802" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        </g>
                                        <defs>
                                            <clipPath id="clip0_6128_2675">
                                                <rect width="24" height="24" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0.52002 0.840088)" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </IconButton>
                                                        ...
                                                        >
                                                            ...
                                                            <defs>
                                                                <clipPath id="clip0_2143_4277">
                                                                    <rect width="24" height="24" fill={scroll ? "#2A3592" : "#fff"} />
                                                                </clipPath>
                                                            </defs>
                                                        </svg>
                                                    </button>
                            ...
                            <IconButton
                                ...
                                <svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_6112_2679)">
                                        <path d="M22.15 3.33496H1.37V22.185H22.15V3.33496Z" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        <path d="M15.23 8.33496V22.185" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        <path d="M8.30005 8.33496V22.185" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        <path d="M22.15 15.2651H1.38" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        <path d="M22.15 8.33496H1.38" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        <path d="M5.76001 6.13502V0.64502" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        <path d="M17.76 6.13502V0.64502" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                    </g>
                                    <defs>
                                        <clipPath id="clip0_6112_2679">
                                            <rect width="22.48" height="22.39" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0.52002 0.64502)" />
                                        </clipPath>
                                    </defs>
                                </svg>
                            </IconButton>
                                                    ...
                                                    <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <defs>
                                                            <clipPath id="clip0_2146_6797">
                                                                <rect width="8.84" height="8.84" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0 0.580078)" />
                                                            </clipPath>
                                                        </defs>
                                                    </svg>
                                                </button>
                                                    ...
                                                    <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <defs>
                                                            <clipPath id="clip0_2146_6803">
                                                                <rect width="15.39" height="17" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0.610352 0.5)" />
                                                            </clipPath>
                                                        </defs>
                                                    </svg>
                                                </button>
                            ...
                            <Box>
                                <Button
                                    ...
                                    endIcon={
                                        <Box sx={{ borderRadius: "50%", width: "20px", height: "20px", background: scroll ? "#2A3592" : "#fff", display: "flex", alignItems: "center", justifyContent: "center" }}>
                                            <Typography sx={{ fontSize: "10px", fontWeight: 700, color: scroll ? "#fff" : "#000000" }}>3</Typography>
                                        </Box>
                                    }>
                                    <svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_6112_2688)">
                                            <path d="M20.1199 9.34985H3.14993L1.23993 22.7399H22.0199L20.1199 9.34985Z" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                            <path d="M13.1299 9.35019V4.19019C13.1299 2.53019 11.7899 1.19019 10.1299 1.19019C8.46994 1.19019 7.12994 2.53019 7.12994 4.19019V9.36019" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                            <path d="M16.53 9.34995V4.18995C16.53 3.29995 16.14 2.49995 15.53 1.94995" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" strokeLinecap="round" />
                                            <path d="M17.63 22.7399L15.72 9.34985" stroke={scroll ? "#2A3592" : "#fff"} strokeWidth="1.7" strokeMiterlimit="10" />
                                        </g>
                                        <defs>
                                            <clipPath id="clip0_6112_2688">
                                                <rect width="23" height="23" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0 0.340088)" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </Button>
                                                                            ...
                                                                            <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                ...
                                                                                <defs>
                                                                                    <clipPath id="clip0_160_1440">
                                                                                        <rect width="8.14" height="8.14" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0 0.929932)" />
                                                                                    </clipPath>
                                                                                </defs>
                                                                            </svg>
                                                                        </button>
                                                                            ...
                                                                            <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                ...
                                                                                <defs>
                                                                                    <clipPath id="clip0_160_1444">
                                                                                        <rect width="8.14" height="8.14" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0.139648 0.929932)" />
                                                                                    </clipPath>
                                                                                </defs>
                                                                            </svg>
                                                                        ...
                                                                        <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            ...
                                                                            <defs>
                                                                                <clipPath id="clip0_160_1450">
                                                                                    <rect width="8.99" height="9.29" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0.0100098 0.424805)" />
                                                                                </clipPath>
                                                                            </defs>
                                                                        </svg>
                                                                            ...
                                                                            <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                ...
                                                                                <defs>
                                                                                    <clipPath id="clip0_422_3736">
                                                                                        <rect width="8.14" height="8.14" fill={scroll ? "#2A3592" : "#fff"} transform="translate(0.859985 0.930054)" />
                                                                                    </clipPath>
                                                                                </defs>
                                                                            </svg>
                                                                            <span>Cart</span>
