                                                        ...
                                                        >
                                                            <g clipPath="url(#clip0_2143_4277)">
                                                                <path
                                                                    ...
                                                                    stroke={getActiveHeader(scroll, hover, headerColor) ? "#2A3592" : "#fff"}
                                                                    strokeWidth="1.7"
                                                                    strokeMiterlimit="10"
                                                                />
                                                                <path
                                                            ...
                                                            <defs>
                                                                <clipPath id="clip0_2143_4277">
                                                                    <rect width="24" height="24" fill={getActiveHeader(scroll, hover, headerColor) ? "#2A3592" : "#fff"} />
                                                                </clipPath>
                                                            </defs>
                                                        </svg>
                                                    </button>
                                                            ...
                                                            <defs>
                                                                <clipPath id="clip0_2143_4283">
                                                                    <rect
                                                                        width="8.59"
                                                                        height="9.29"
                                                                        fill={getActiveHeader(scroll, hover, headerColor) ? "#2A3592" : "#fff"}
                                                                        ...
                                                                        <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            ...
                                                                            <defs>
                                                                                <clipPath id="clip0_160_1440">
                                                                                    <rect width="8.14" height="8.14" fill={getActiveHeader(scroll, hover, headerColor) ? "#2A3592" : "#fff"} transform="translate(0 0.929932)" />
                                                                                </clipPath>
                                                                            </defs>
                                                                        </svg>
                                                                    </button>
                                                                        ...
                                                                        <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            ...
                                                                            <defs>
                                                                                <clipPath id="clip0_160_1444">
                                                                                    <rect width="8.14" height="8.14" fill={getActiveHeader(scroll, hover, headerColor) ? "#2A3592" : "#fff"} transform="translate(0.139648 0.929932)" />
                                                                                </clipPath>
                                                                            </defs>
                                                                        </svg>
                                                                    ...
                                                                    <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        ...
                                                                        <defs>
                                                                            <clipPath id="clip0_160_1450">
                                                                                <rect width="8.99" height="9.29" fill={getActiveHeader(scroll, hover, headerColor) ? "#2A3592" : "#fff"} transform="translate(0.0100098 0.424805)" />
                                                                            </clipPath>
                                                                        </defs>
                                                                    </svg>
                                                                        ...
                                                                        <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            ...
                                                                            <defs>
                                                                                <clipPath id="clip0_422_3736">
                                                                                    <rect width="8.14" height="8.14" fill={getActiveHeader(scroll, hover, headerColor) ? "#2A3592" : "#fff"} transform="translate(0.859985 0.930054)" />
                                                                                </clipPath>
                                                                            </defs>
                                                                        </svg>
                                                                        <span>Cart</span>
